...
# Dependencies including context, aop, web, webmvc and their transitive requirements
JARS = {
    ...
    "spring-web-5.3.30.jar": "https://repo1.maven.org/maven2/org/springframework/spring-web/5.3.30/spring-web-5.3.30.jar",
    "spring-webmvc-5.3.30.jar": "https://repo1.maven.org/maven2/org/springframework/spring-webmvc/5.3.30/spring-webmvc-5.3.30.jar"
}
...
def compile_and_run():
    ...
    # Run classpath needs bin, src/main/resources, and all jars
    ...
    # Run
    print("\nRunning com.library.LibraryManagementApplication...")
    cmd_run = ["java", "-cp", run_classpath, "com.library.LibraryManagementApplication"]
